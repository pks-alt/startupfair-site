...
LinkedIn is the only marketing social channel. The current working source had no Facebook, Instagram, X/Twitter, TikTok or Pinterest footer links to remove. Four referral selectors saying LinkedIn or social media now say LinkedIn. The owner supplied https://www.linkedin.com/company/startupfair/home/?viewAsMember=true; the website uses the public company URL https://www.linkedin.com/company/startupfair/ without the home/member-view suffix. The footer now says Follow on LinkedIn and opens that company page in a new tab. The same owner-supplied URL is used for Organization sameAs. This is a website link update, not independent account-ownership verification. No LinkedIn account is created, modified or followed, and nothing is posted automatically.
